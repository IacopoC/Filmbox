...
@section('content')
                    ...
                    @endforeach
                        <div class="col-lg-12">
                            <div class="button-box">
                                <button class="btn-secondary btn-more-results-fantasy">Mostra più risultati  <i class="fa fa-fw fa-chevron-down"></i></button>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".btn-more-results-fantasy").click(function () {
                $(this).hide();

                $.ajax({
                    url: `https://api.themoviedb.org/3/discover/movie?api_key=${api_key}&with_genres=14&sort_by=vote_average.desc&vote_count.gte=10&page=2`,
                    dataType: 'json',
