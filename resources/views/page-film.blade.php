                         ...
                         <!--Fine sezione cast-->
                          ...
                          <p><strong>Trailer disponibili:</strong>
                           ...
                           @endif
                             ...
                             <div class="votes-box">
                            <p class="d-inline"><strong>Voto medio: </strong></p>
                                @if($film_obj->vote_average > 0 and $film_obj->vote_average < 4 )
                                ...
                                @elseif($film_obj->vote_average > 4 and $film_obj->vote_average < 6)
                                ...
                                @elseif($film_obj->vote_average > 6 and $film_obj->vote_average <8)
                                ...
                                @elseif($film_obj->vote_average > 8)
                           ...
                           <fieldset>
                            ...
                            <span class="star-cb-group">
                              <label for="sad">
                                ...
                                <label for="neutral">
                                <input type="radio" id="rating-id-6" class="neutral" name="rating" value="6" />
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="100%" height="100%" viewBox="0 0 24 24"><path d="M8.5,11A1.5,1.5 0 0,1 7,9.5A1.5,1.5 0 0,1 8.5,8A1.5,1.5 0 0,1 10,9.5A1.5,1.5 0 0,1 8.5,11M15.5,11A1.5,1.5 0 0,1 14,9.5A1.5,1.5 0 0,1 15.5,8A1.5,1.5 0 0,1 17,9.5A1.5,1.5 0 0,1 15.5,11M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22C6.47,22 2,17.5 2,12A10,10 0 0,1 12,2M9,14H15A1,1 0 0,1 16,15A1,1 0 0,1 15,16H9A1,1 0 0,1 8,15A1,1 0 0,1 9,14Z" /></svg></label>
