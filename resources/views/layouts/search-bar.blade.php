 ...
 <form action="{{ url('/search') }}" method="get" onsubmit="return emptyField()">
     <input class="form-control searchfilm-field" name="q" type="text" placeholder="Cerca per titolo..." aria-label="Search" value="@if(isset($_GET['q'])) {{ htmlentities($_GET['q']) }} @endif" id="film-field">
