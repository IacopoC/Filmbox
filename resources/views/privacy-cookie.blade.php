...
@section('title')
    Privacy e Cookie policy - Filmbox
@endsection
@section('content')
    <section>
        <div class="container">
            <div class="margin-up">
                <h4 class="text-uppercase">Privacy e Cookie policy</h4>
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <p><strong>Attività di salvataggio delle preferenze, ottimizzazione e statistica</strong></p>
                                    ...
                                    <p>
                                        <strong>Interazione con social network e piattaforme esterne</strong></p>
                                    <p>
                                    ...
                                    <p>
                                        <strong> Statistica</strong></p>
                                    <p>
                                    I servizi contenuti nella presente sezione permettono al Titolare del Trattamento di monitorare e analizzare i dati di traffico e servono a tener traccia del comportamento dell’Utente.
                                    </p>
                                    <p>
                                        <strong>Google Analytics (Google Inc.)</strong></p>
                                    <p>
                                    ...
                                    <p>
                                        <strong>Google Adsense (Google Inc.)</strong></p>
                                    <p>
                                    Google Adsense è un servizio di fornitura di banner pubblicitari fornito da Google Inc. (“Google”). Google utilizza i Dati degli utenti raccolti allo scopo di fornire banner pubblicitari per l’utente.
                                    Google potrebbe utilizzare i Dati Personali per contestualizzare e personalizzare gli annunci del proprio network pubblicitario.
                                    Dati personali raccolti: Cookie e Dati di utilizzo.
                                    Luogo del trattamento : USA – Privacy Policy – Opt Out
                                    </p>
                                    <p>
                                        <strong>Maggiori informazioni per disattivazione di annunci personalizzati</strong>
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                    <strong>Definizioni e riferimenti legali
                                        Dati Personali (o Dati)</strong></p>
                                    <p>
